...
import com.example.homework8_6.databinding.ItemPlaylistsBinding
...
class PlaylistsAdapter(private val onClick:(BaseResponse.Item)->Unit):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PlaylistsViewHolder {
        return PlaylistsViewHolder(ItemPlaylistsBinding.inflate(LayoutInflater.from(parent.context), parent, false), onClick)
    }
